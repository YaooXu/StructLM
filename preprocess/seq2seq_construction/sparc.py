...
def sparc_add_serialized_schema(
    ...
    serialized_schema, schema_tuples = serialize_schema(
    ...
    return {"serialized_schema": serialized_schema, "schema_tuples": schema_tuples}
...
def serialize_schema(
    ...
    # added
    def get_schema_tuples():
        schema_tuples = []
        schemas = [(
            table_name.lower() if normalize_query else table_name,
            list(map(
        ...
        for schema in schemas:
            table_name, cols = schema[0], schema[1]
            for col in cols:
                schema_tuples.append((table_name, 'has_column', col))
    ...
    schema_tuples = get_schema_tuples()
    return serialized_schema, schema_tuples
