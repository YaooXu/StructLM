...
# cfg=hytrel-phi/v2-10M-200k-freeze_llama_pretraining.cfg
cfg=hytrel-mistral/v2-10M_query_token_200k-only_query-not_freeze_gnn-trained_roberta_base-lora4_32_llama-10.cfg
...
deepspeed --master_port=${master_port} --include=${include} train_sqformer.py \
    ...
    --output_dir=./outputs/${dataset_dir}-10_tasks-w_inverse_rel/${cfg} \
    --seed=0 \
